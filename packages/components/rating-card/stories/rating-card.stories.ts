...
export default {
  ...
  argTypes: {
    id: {
      control: 'text',
      description:
        'Sets the id html attribute of puik-rating-card. If this prop is not configured, an id will be automatically generated by using this pattern : puik-rating-card-{randomNumber}',
      table: {
        defaultValue: {
    ...
    totalRatings: {
      description: 'An array of all ratings (set of numbers from 0 to 5 - including decimal values)',
      control: { type: 'array' }
    },
    variant: {
