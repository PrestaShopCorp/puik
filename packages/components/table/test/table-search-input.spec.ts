...
import { PuikTableSearchInput, TableSearchInputProps, PuikTableHeader, searchOption } from '@prestashopcorp/puik-components';
...
describe('TableSearchInput tests', () => {
  ...
  const factory = (
    ...
    options?: ComponentMountingOptions<typeof PuikTableSearchInput>
  ) => {
